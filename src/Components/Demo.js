            ...
            <div className="today-weather">
              ...
              <div className="search-box">
                ...
                <div className="img-box" onClick={getCityValue}>
                  {" "}
                  <img src="https://images.avishkaar.cc/workflow/newhp/search-white.png" alt="weather"/>
                </div>
              </div>
              {errorCode === false?
              <>
              <ul>
                ...
                />
                  ...
                  <li>
                    Temperature <span className="temp">{Math.round(forcast.main?.temp)}°c</span>
                  </li>
                  <li>
                    Humidity <span className="temp">{forcast.main?.humidity}%</span>
                  </li>
                  <li>
                    Visibility <span className="temp">{Math.round(forcast.visibility * 0.00062137)} mi</span>
                  </li>
                  <li>
                    Wind Speed <span className="temp">{forcast.wind?.speed} Km/h</span>
                  </li>
                </div>
              </ul>
              </>: null}
